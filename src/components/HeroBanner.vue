...
const FacebookLink = 'https://www.facebook.com/FraydSpaghetti';
const LinkedinLink = 'https://www.linkedin.com/in/tago-christian-kirl-d-288b8a29b/';
const GithubLink = 'https://github.com/fraydspaghetti';


</script>

<template>
    <section class="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row py-16">
        <!-- content - start -->
        <div class="flex flex-col justify-between xl:w-5/12">
            <div></div>

            <div class="sm:text-center lg:py-12 lg:text-left xl:py-24">
                <p class="mb-4 font-semibold text-gray-600 md:mb-6 md:text-lg xl:text-xl">Greetings!</p>

                <h1 class="mb-8 text-4xl font-bold text-cyan-700 sm:text-5xl md:mb-12"> Hi guys I'm Christian Kirl D. Tago your friendly programmer at your service.
</h1>
            ...
            <div class="mt-8 flex items-center justify-center gap-4 sm:mt-16 lg:justify-start">
                <span class="text-sm font-semibold uppercase tracking-widest text-gray-400 sm:text-base">Socials</span>
        ...
        <div class="h-48 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:h-auto xl:w-5/12">
            <img src="../assets/kirl.jpg"
                loading="lazy" alt="MyPhoto" class="h-full w-full object-cover object-center" />
        </div>
    </section>
</template>